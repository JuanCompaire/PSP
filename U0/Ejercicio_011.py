...
# la cual almacena por cada una de sus filas el salario trimestral de
# cada uno de los empleados de la empresa.
# int salarios[][] = { {700, 900, 1300} , {1000, 950, 1080},
# {1300, 930, 1200} }
#A su vez, disponemos también de una tabla empleados,
# con los nombres de los trabajadores:
...
for i in range(len(salarios)):
    suma = sum(salarios[i])
    print(empleados[i]+" -> "+ str(salarios[i][0])+" "+ str(salarios[i][1])+" "+ str(salarios[i][2])+" = "+str(suma))
